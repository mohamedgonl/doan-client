...
class Node {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = idTamThoi;
    data['ma_chia_se'] = maChiaSe;
    data['ancestor_id'] = ancestorId;
    data['descendant_id'] = descendantId;
    data['depth'] = depth;
  ...
  static MemberInfo castMemberInfoFromNode(Node node) {
    return MemberInfo(
      ...
      email: node.email,
      trinhDo: node.trinhDo,
      nguyenQuan: node.nguyenQuan,
      diaChiHienTai: node.diaChiHienTai,
      trangThaiMat: node.trangThaiMat,
      tieuSu: node.tieuSu,
      ngayMat: node.ngayMat,
      ngayGio: node.ngayGio,
      noiThoCung: node.noiThoCung,
      nguoiPhuTrachCung: node.nguoiPhuTrachCung,
      ngheNghiep: node.ngheNghiep,
      moTang: node.moTang,
      trucXuat: node.trucXuat,
      lyDoTrucXuat: node.lyDoTrucXuat,
      thoiGianTao: node.thoiGianTao,
      chucVu: node.chucVu,
      chucVuId: node.chucVuId,
      pid: node.pid,
      cid: node.cid,
      root: node.root,
    );
