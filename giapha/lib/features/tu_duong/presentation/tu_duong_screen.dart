                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              "Ngày giỗ: ${(user.value.ngayGio.isNotNullOrEmpty) ? "${DateTimeShared.convertSolarToLunar(DateTimeShared.formatStringReverseToDate8(user.value.ngayGio!))} (ÂL)" : "Chưa có thông tin"}",
                                              style: Theme.of(context)
                                                  .primaryTextTheme
                                                  .bodySmall,
                                            ),
                                            ...
                                            Text(
                                              "Mộ táng: ${user.value.moTang.isNotNullOrEmpty ? user.value.moTang : "Chưa có thông tin"}",
                                              overflow: TextOverflow.ellipsis,
                                              style: Theme.of(context)
                                                  .primaryTextTheme
                                                  .bodySmall,
                                            ...
                                            Text(
                                              "Thờ cúng: ${user.value.noiThoCung.isNotNullOrEmpty ? user.value.noiThoCung : "Chưa có thông tin"}",
                                              overflow: TextOverflow.ellipsis,
                                              style: Theme.of(context)
                                                  .primaryTextTheme
                                                  .bodySmall,
                                            ...
                                            Text(
                                              "Người phụ trách: ${user.value.nguoiPhuTrachCung.isNotNullOrEmpty ? user.value.nguoiPhuTrachCung : "Chưa có thông tin"}",
                                              overflow: TextOverflow.ellipsis,
                                              style: Theme.of(context)
                                                  .primaryTextTheme
                                                  .bodySmall,
