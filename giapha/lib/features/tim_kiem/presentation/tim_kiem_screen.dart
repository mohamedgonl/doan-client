...
import 'package:giapha/core/components/show_dialog_picker_view.dart';
...
class _TimKiemScreenState extends State<TimKiemScreen>
  ...
  List<String> listTextThanhVien = [];
  List<String> listTextGiaPha = [];
  ...
  Future<void> _initializeState() async {
    userId = await AuthService.getClientId();
    listTextThanhVien = _timKiemThanhVienBloc.getLocalSaveSearch(userId);
    listTextGiaPha = _timKiemGiaPhaBloc.getLocalSaveSearch(userId);
  }
