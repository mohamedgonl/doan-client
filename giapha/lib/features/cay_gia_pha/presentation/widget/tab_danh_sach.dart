                ...
                child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        node.trucXuat == TrucXuatConst.biTrucXuat
                            ? Align(
                            ...
                            : node.chucVu.isNotNullOrEmpty
                                ? Row(
                                    children: [
                                      Expanded(child: Container()),
                                      Container(
                                        width: node.chucVu!.length > 8
                                            ? 90.w
                                            : null,
                                        padding: EdgeInsets.symmetric(
                                            horizontal: 12.w, vertical: 3.h),
                                        decoration: BoxDecoration(
                                            color: const Color(0xffF0C24A),
                                            borderRadius: BorderRadius.only(
                                              topRight: Radius.circular(8.r),
                                              bottomRight: Radius.circular(8.r),
                                              topLeft: Radius.circular(90.r),
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Text(
                                                                                "${danhsachthanhvienBuildItems[indexThanhVien].trangThaiMat == TrangThaiMatConst.daMat ? "Đã mất" : "Còn sống"}${danhsachthanhvienBuildItems[indexThanhVien].chucVu == null ? "" : " • ${danhsachthanhvienBuildItems[indexThanhVien].chucVu}"}",
                                                                                overflow: TextOverflow.ellipsis,
