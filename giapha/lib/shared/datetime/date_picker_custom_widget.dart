...
import 'picker_custom_widget.dart' as picker_custom;
...
TextStyle _themeTextStyle(BuildContext context, {bool isValid = true}) {
  final TextStyle style = cupertino.CupertinoTheme.of(context)
      .textTheme
  ...
  return isValid
      ...
      : style.copyWith(
          color: cupertino.CupertinoDynamicColor.resolve(
              cupertino.CupertinoColors.inactiveGray, context));
}
...
Widget _startSelectionOverlay = Column(
  children: [
    Container(
      height: 0.25,
...
Widget _centerSelectionOverlay = Column(
  children: [
    Container(
      height: 0.25,
      width: double.infinity,
...
Widget _endSelectionOverlay = Column(
  children: [
    Container(
      height: 0.25,
      width: double.infinity,
...
class DatePickerCustomWidget extends StatefulWidget {
  ...
  /// Defaults to the locale's default date format/order.
  final cupertino.DatePickerDateOrder? dateOrder;
  ...
  static double _getColumnWidth(
    ...
    cupertino.CupertinoLocalizations localizations,
...
class _CupertinoDatePickerDateTimeState extends State<DatePickerCustomWidget> {
  ...
  late cupertino.CupertinoLocalizations localizations;
  ...
  @override
  void didUpdateWidget(DatePickerCustomWidget oldWidget) {
  ...
  void didChangeDependencies() {
    ...
    localizations = cupertino.CupertinoLocalizations.of(context);
  ...
  double _getEstimatedColumnWidth(_PickerColumnType columnType) {
    if (estimatedColumnWidths[columnType.index] == null) {
      estimatedColumnWidths[columnType.index] =
          DatePickerCustomWidget._getColumnWidth(
  ...
  Widget _buildMediumDatePicker(double offAxisFraction,
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: cupertino.CupertinoPicker.builder(
  ...
  Widget build(BuildContext context) {
    ...
    if (!widget.use24hFormat) {
      if (localizations.datePickerDateTimeOrder ==
              cupertino.DatePickerDateTimeOrder.date_time_dayPeriod ||
          localizations.datePickerDateTimeOrder ==
              cupertino.DatePickerDateTimeOrder.time_dayPeriod_date) {
    ...
    if (widget.mode == CupertinoDatePickerMode.dateAndTime) {
      if (localizations.datePickerDateTimeOrder ==
              cupertino.DatePickerDateTimeOrder.time_dayPeriod_date ||
          localizations.datePickerDateTimeOrder ==
              cupertino.DatePickerDateTimeOrder.dayPeriod_time_date) {
...
class _CupertinoDatePickerDateState extends State<DatePickerCustomWidget> {
  ...
  Widget _buildDayPicker(double offAxisFraction,
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: picker_custom.CupertinoPicker(
        scrollController: dayController,
        onTapToSelect: widget.onTapToSelect,
        offAxisFraction: offAxisFraction,
        itemExtent: _kItemExtent,
        useMagnifier: _kUseMagnifier,
        magnification: _kMagnification,
      ...
      child: picker_custom.CupertinoPicker(
        ...
        children: List<Widget>.generate(12, (int index) {
          ...
          return itemPositioningBuilder(
            context,
            Text(
              '${localizations.datePickerMonth(month)[0].toUpperCase()}${localizations.datePickerMonth(month).substring(1).toLowerCase()}',
  ...
  Widget _buildYearPicker(double offAxisFraction,
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: picker_custom.CupertinoPicker.builder(
        onTapToSelect: widget.onTapToSelect,
  ...
  Widget build(BuildContext context) {
    ...
    final cupertino.DatePickerDateOrder datePickerDateOrder =
        dateOrder ?? localizations.datePickerDateOrder;

    switch (datePickerDateOrder) {
      case cupertino.DatePickerDateOrder.mdy:
        ...
        break;
      case cupertino.DatePickerDateOrder.dmy:
        pickerBuilders = <_ColumnBuilder>[
          _buildDayPicker,
          _buildMonthPicker,
          _buildYearPicker
        ...
        break;
      case cupertino.DatePickerDateOrder.ymd:
        pickerBuilders = <_ColumnBuilder>[
          _buildYearPicker,
          _buildMonthPicker,
          _buildDayPicker
        ...
        break;
      case cupertino.DatePickerDateOrder.ydm:
        pickerBuilders = <_ColumnBuilder>[
          _buildYearPicker,
          _buildDayPicker,
          _buildMonthPicker
...
class _CupertinoTimerPickerState extends State<CupertinoTimerPicker> {
  ...
  TextStyle _textStyleFrom(BuildContext context, [double magnification = 1.0]) {
    final TextStyle textStyle =
        cupertino.CupertinoTheme.of(context).textTheme.pickerTextStyle;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        final cupertino.CupertinoThemeData themeData =
        ...
        return MediaQuery(
          ...
          child: cupertino.CupertinoTheme(
            ...
            child: Align(
              ...
              child: Container(
                color: cupertino.CupertinoDynamicColor.maybeResolve(
