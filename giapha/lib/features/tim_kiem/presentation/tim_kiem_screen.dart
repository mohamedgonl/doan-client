...
class _TimKiemScreenState extends State<TimKiemScreen>
  ...
  final ValueNotifier<ChucVuModel> _chucVuFillter =
      ValueNotifier(ChucVuModel(id: "", tenChucVu: ""));
  ...
  void initState() {
    ...
    if (widget.idGiaPha.isNotNullOrEmpty) {
      quanLyChucVuBloc.add(LayChucVuEvent(widget.idGiaPha!));
    }
  ...
  _showDialogChucVu(
    String title,
    String iconTitle,
    ValueNotifier<ChucVuModel> notifiSelect,
  ) {
    //_unFocus();
    showCupertinoModalPopup(
        context: context,
                            ...
                            children: [
                              ...
                              if (widget.idGiaPha.isNotNullOrEmpty)
                                ValueListenableBuilder(
                                  valueListenable: _chucVuFillter,
                                  builder: (context, _, __) {
                                    return itemFill(
                                        IconConstants.icHoTen,
                                        "Chức vụ",
                                        _chucVuFillter.value.tenChucVu,
                                        onSelect: () {
                                      _showDialogChucVu(
                                        "Chọn chức vụ".toUpperCase(),
                                        iconTitle,
                                        _chucVuFillter,
                                      );
                                    });
  ...
  void onSearch() {
    if (_tabController.index == 0 &&
        (_textSearchController.text.isNotEmpty ||
            _chucVuFillter.value.id.isNotNullOrEmpty ||
      ...
      _timKiemThanhVienBloc.add(TimKiemThanhVienTheoText(
        ...
        idChucVu: _chucVuFillter.value.id,
  ...
  bool checkHasBoLoc() {
    if (tabCurrent == 0) {
      if (_chucVuFillter.value.id.isNotNullOrEmpty ||
          _gioiTinhFillter.value.isNotNullOrEmpty ||
          _namSinhFillter.value != null) {
        return true;
      }
                        ...
                        child: AcAppBarButton.custom(
                            onPressed: () {
                              _showDialogFillThanhVien(
                                ...
                                if (tabCurrent == 0) {
                                  _chucVuFillter.value =
                                      ChucVuModel(id: "", tenChucVu: "");
                                  _namSinhFillter.value = null;
