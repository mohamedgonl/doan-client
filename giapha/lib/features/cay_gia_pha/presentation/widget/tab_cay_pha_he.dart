...
class _TabCayPhaHeState extends State<TabCayPhaHe> {
  ...
  List<String> arrayMaChiaSeHopLe = [];
                              ...
                              MaterialPageRoute(
                                builder: ((context) {
                                  return quanLyThanhVienBuilder(
                                    ...
                                    saveCallApi: false,
                                    addBoMe: true,
                                    arrayMaChiaSe: arrayMaChiaSeHopLe,
                                  );
                                }),
                              ),
                            );
                            if (info != null && info is MemberInfo) {
                              addMaChiaSeLocal(info.maChiaSe);
                              onClickAddBoMe(info);
                            }
                          },
  ...
  void addMaChiaSeLocal(String? maChiaSe) {
    if (maChiaSe.isNotNullOrEmpty) {
      arrayMaChiaSeHopLe.add(maChiaSe!);
    }
  }
